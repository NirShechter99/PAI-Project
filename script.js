const levels = [
    ...
    {
        id: 7,
        instruction: "Create a tight defensive block! Stack 6 players in a column, center them on the pitch, and make sure they stick to the top.",
        players: 6,
        expected: { display: "flex", "flex-direction": "column", "justify-content": "flex-start", "align-items": "center" }
    },
    {
        id: 8,
...
function resetProperties() {
    selects.forEach(select => {
        ...
        pitch.style.removeProperty(select.id);
    });
